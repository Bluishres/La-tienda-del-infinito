...
- **SDK**: 
  ...
  - Frontend: [Dart SDK 2.0.4](https://dart.dev/get-dart), [Android SDK](https://developer.android.com/studio).

- **Control de versiones**: En este proyecto se usará GitHub como sistema de control de versiones. Estará distribuído a través de 3 repositorios, que son:
...
**[1. Instalación del entorno para el Frontend](#FRONTEND)**
...
## Instalación del entorno para el Frontend
